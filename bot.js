...
if (msg.content.toLowerCase() === 'hüseyin') {
  msg.channel.sendMessage('karınca adam');
}
if (msg.content.toLowerCase() === 'selin') {
  msg.channel.sendMessage('seliğnğnğnğn');
}
if (msg.content.toLowerCase() === 'sercan') {
  msg.channel.sendMessage('sercağnğnğnğn');
}
if (!msg.content.startsWith(prefix)) {
   return;
}
if (msg.content.toLowerCase() === prefix + 'dozza' ) {
msg.reply('buyrun')
}
});
